...
import { Mic, MicOff, Wifi, WifiOff, RefreshCw, X, Volume2, CheckCircle2 } from 'lucide-react';
import { DiagramModel, VoiceCommandQueueItem } from '../../types/case';
import { enqueueVoiceCommand, getOfflineVoiceQueue, processNaturalLanguagePrompt, saveOfflineVoiceQueue } from '../../services/aiAssistant';
...
export const VoiceAssistantModal: React.FC<VoiceAssistantModalProps> = ({
  ...
  const [assistantReply, setAssistantReply] = useState('Hola, soy tu asistente CASE-AI. Habla para modelar o consultar tu arquitectura.');
  ...
  return (
    <div style={{
      ...
      <div className="glass-panel" style={{
        ...
        {/* Center: Voice Wave Visualizer & Status */}
